...
{
    public static class LuaValidationService
    {
        ...
        public static List<string> Validate(string luaCode)
        {
            var errors = new List<string>();

            if (string.IsNullOrWhiteSpace(luaCode))
            {
                errors.Add("Lua script is empty.");
                return errors;
            }
            ...
            {
                errors.Add("Syntax error: " + e.DecoratedMessage);
            }
            catch (ScriptRuntimeException e)
            {
                errors.Add("Runtime error: " + e.DecoratedMessage);
            }
            catch (Exception e)
            {
